...
<body>
    <div class="mobile-menu">
        <ul class="mobile-menu-nav">
            ...
            <li class="mobile-menu-nav-item">
                <a href="./about.php" class="mobile-menu-link">Контрактное производство</a>
    ...
    <nav class="navbar navbar-light">
        ...
        <ul class="header-nav">
            ...
            <li class="header-nav-item"><a href="./about.php" class="header-nav-link">Контрактное производство</a>
            </li>
    ...
    <header class="header hero hero-text-only">
        <div class="container hero">

            <div class="hero-content">
                <div class="seporator"></div>
                <h1 class="hero-title">о компании</h1>
            ...
            <nav class="breadcrumbs">
                <a href="index.html" class="hero-link">Главная</a> — <span>О компании</span>
            </nav>
