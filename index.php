...
<body class="front-page">
        ...
        <ul class="mobile-menu-nav">
            ...
            <li class="mobile-menu-nav-item">
                ...
                <ul class="mobile-submenu">
                    <li class="mobile-submenu-item"><a href="./avto_him.html" class="mobile-submenu-link">Автомобильная
                            химия</a></li>
    ...
    <nav class="navbar">
        ...
        <ul class="header-nav">
            ...
            <li class="header-nav-item"><a href="./contract.html" class="header-nav-link">Контрактное производство</a>
            </li>
    ...
    <header class="header header-image">
        <div class="container">
            ...
            <div class="swiper features-slider">
                ...
                <!-- Кнопки навигации вперед/назад navigation buttons -->
    ...
    <section class="section production">
        <div class="container">
            ...
            <div class="cards">
                <a href="./avto_him.html" class="card">
            ...
            <div class="founder-content-wrapper">
                <div class="founder-content">
                    ...
                    <p class="founder-text">Кстати, интерактивные прототипы описаны максимально подробно. Повседневная
                        ...
                        тестирование
                        выявляет срочную потребность системы массового участия. А ещё действия представителей оппозиции,
                        превозмогая сложившуюся непростую экономическую ситуацию, в равной степени предоставлены сами
                        себе.
                        Не следует, однако, забывать, что выбранный нами инновационный путь в значительной степени
                        обусловливает важность дальнейших направлений развития.</p>
                    <a href="./about.html" class="button-link">Подробнее о компании</a>
            ...
            <div class="clients-wrapper">
                ...
                <div class="clients-logo-list">
                    ...
                    <a href="#" class="clients-logo-item">
                        <img src="./img/Burger_King.png" alt="" class="clients-logo">
                    </a>
        ...
        <div class="container">
            ...
            <div class="swiper blog-slider">
                <div class="swiper-wrapper">
                    <!-- Additional required wrapper -->
                    <a href="#" class="swiper-slide blog-card"><img src="./img/blog/blog_photo_1.jpg" alt="blog_photo_1"
                    ...
                    <a href="#" class="swiper-slide blog-card"><img src="./img/blog/blog_photo_2.jpg" alt="blog_photo_1"
                            class="blog-card-image">
                ...
                <div class="blog-slider-footer">
                    ...
                    <!-- navigation buttons blog-buttons-->
                </div>
                ...
                <div class="footer-menu-wrapper">
                    ...
                    <ul class="footer-menu-list footer-menu-column-2">
                        <li class="footer-menu-item">
                            <a href="./avto_him.html" class="footer-menu-link">Автомобильная химия</a>
                        </li>
                        <li class="footer-menu-item">
